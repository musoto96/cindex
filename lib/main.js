  ...
  if (answer) {
    ...
    Promise.all(createPromises)
      .then(() => {
        ...
        fs.promises.writeFile(`${path}/${_config.dirs.index}/_tags.html`, tagIndex());
    ...
    for (const draft of missing) {
      ...
      if (newTags && newTags.length > 0) {
        ...
        for (const tag of tags) {
          ...
          // TODO
          //const categoryIndex = createPage(sampleCategoryPage(_config.files.index, tag), newCategoryIndex, "tag").page;
        ...
        for (const tag of newTags) {
          ...
          // Update tag index
          const newTagIndex = await updateIndex(`${path}/${_config.dirs.index}`, tag, `${_config.dirs.categories}/${tag}.html`, fileDate + ", " + fileTime, tag, indexFile="_tags.html", useDate=false);
