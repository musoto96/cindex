  ...
  <div class="site-content">
    ...
    <div class="page-content">
      ...
      <!--
        ...
        The content below will be shown across all pages. To change it change the template file, and regenerate the pages with: 
          cindex up PATH
      ...
      <div class="halfpad">
        You can edit it, add or remove html elements. This content will be present for every new page you create.
      </div>
      <div class="halfpad">
...
const sampleDraft = `<section class="pad">
  ...
  <p class="date pad subtitle">May 25, 2024.</p>
    ...
    <p>
      This is the html content that was injected from a <span class="icode">draft</span> into a <span class="icode">template</span> to create a resulting file inside the directory <span class="icode">pages</span>
    </p>

    <br>

    <div>You can remove this page, by deleteing <span class="icode">drafts/sample.html</span> and running:</div>
    <div>
      <p class="code">
        cindex up PATH
      </p>
    </div>
    <div>Or by manually deleting both the sample and the page.</div>
...
<div class="wrapper">
  ...
  <div>
    ...
    <br>
    <p>
      This is your index page. You can edit it directly following the inline comments in the html file.<br>
      Don't worry they are short comments.<br>
      <br>
      If you just initialized a website with cindex, the pages index below will likely be empty.
      To test it run:
    </p>
    <p class="code">
      cindex gen
